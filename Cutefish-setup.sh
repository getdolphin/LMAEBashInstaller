...
if (whiptail --title "Linux Mint Arch Edition | Cutefish Setup" --yesno "Are you sure you want to continue installing?" 8 40 --yes-button "Yes" --no-button "No"); then
	yay -Syyu --noconfirm cutefish vlc cutefish-calculator cutefish-core cutefish-cursor-themes-git cutefish-gtk-themes-git cutefish-kwin-plugins cutefish-screenshot-git cutefish-videoplayer-git sddm | \
